...
export const DATA = {
  name: "Amrit Barsaiyan",
  initials: "AB",
  url: "https://amrithehe.com",
  ...
  contact: {
    ...
    social: {
      GitHub: {
        name: "GitHub",
        url: "https://github.com/amrithehe",
        icon: Icons.github,
  ...
  education: [
    {
      school: "100xSchool",
      href: "https://school.100xdevs.com",
      degree: "super30",
      logoUrl: "/100xSchool.ico",
      start: "2025",
      end: "2026",
    },
    {
  ...
  projects: [
    ...
    },
    {
      ...
      links: [
        ...
        {
          type: "Source",
          href: "https://github.com/AmritHehe/Xness",
          icon: <Icons.github className="size-3" />,
        },
      ],
      image: "",
      video: "/videos/exness-demo.mp4",
    },
    {
      title: "CollabyDraw",
